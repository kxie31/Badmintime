...
public class ClubEvent extends Event {
    ...
    @Ignore
    private CalendarEvent overlapEvent2; // the second conflict calendar event object
    @ColumnInfo
    private int overlapEventID2; // ID of the second conflict calendar event
    @ColumnInfo
    ...
    @Ignore
    private static final String[] allAttrs = new String[]{"Start", "End", "dayOfWeek", "clubName"};
    @Ignore
    private Context ctx; // context of the activity
    private final static Calendar cal = Calendar.getInstance(); // calendar instance
    private final static int offset = cal.get(Calendar.ZONE_OFFSET); // time zone offset
    private final static ZoneOffset zone = ZoneOffset.ofTotalSeconds(offset/1000); // time zone
    @Ignore
    private ContentResolver cr; // content resolver
    public static Context DMctx; // context of DataManager class
    ...
    /**
     * the getter method for the static field AllAttrs
     * @return
     */
    ...
    /**
     * setter method for the ID of the second overlap event
