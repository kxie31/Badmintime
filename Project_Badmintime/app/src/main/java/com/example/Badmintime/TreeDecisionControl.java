...
public class TreeDecisionControl {
    ...
    private static String chooseAttr(List<ClubEvent> events) {
        ...
        String bestAttr = "";
        String[] basicAttrs = ClubEvent.getAllAttrs();
    ...
    /**
     * This method calculates the entropy of the Calendar event list
     * @param actions the list of calendar events
     * @return the result entropy
     */
    ...
    /**
     * This method choose the word which has the lowest entropy from the calendar event list
     * @param actions the calendar event list
     * @return the word with lowest entropy
     */
    ...
    /**
     * This method retrains the tree using the calendar event list when there are more than 3 events
     * @param pastAction the calendar event list
    ...
    /**
     * This method retrains the tree using the input calendar event list
     * @param pastAction the calendar event list
    ...
    /**
     * place holder for range tree method
     * @param pastAction
     * @return
     */
    @RequiresApi(api = Build.VERSION_CODES.O)
...
//        return new RangeTree(timeStamp,null,new ActionNode(Action, entropyCal(pastAction)));
    ...
    /**
     * this method counts the most common action
     * @param pastAction the calendar event list
     * @return the most common action
     */
    ...
    /**
     * this method pass the event into the tree
     * @param event the new event
     * @param root root of the tree
     * @return the result action node of the event
     */
